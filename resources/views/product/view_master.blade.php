        ...
        <div class="row">
                                        ...
                                        <div class="product-action hidden-md hidden-sm hidden-xs clearfix">
                                            <form action="/cart/add" method="post" class="variants form-nut-grid margin-bottom-0" data-id="product-actions-13395964" enctype="multipart/form-data">
                                                <div>
                                                    ...
                                                    <a href="{{route('add-cart',['id'=>$pro->id])}}"  class="btn-cart btn btn-primary  left-to" title="Chọn sản phẩm">
            ...
            <aside class="dqdt-sidebar sidebar left left-content col-lg-3 col-lgg-2 col-lg-pull-9 col-lgg-pull-10">
                    ...
                    <div>
                        ...
                        <div class="aside-content related-product">
                            <div class="product-mini-lists">
                                <div class="products">
                                    @foreach($product_care as $pro2)
                                    <div class="row row-noGutter">
                                        <div class="col-sm-12">
                                            <div class="product-mini-item clearfix  ">
                                                <div class="product-img relative">
                                                    <a href="{!!route('frontend.product_detail',['id' => $pro2->id])!!}">
                                                        <img src="{{url('uploads/product')}}/{{$pro2->image}}">
                                                    </a>
                                                </div>
                                                <div class="product-info">
                                                    <h3><a href="{!!route('frontend.product_detail',['id' => $pro2->id])!!}" title="{{$pro2->name}}" class="product-name">{{$pro2->name}}</a></h3>
                                                    <div class="price-box">
                                                        <div class="special-price"><span class="price product-price">{{number_format($pro2->price)}}₫</span> </div> <!-- Giá -->
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <aside class="aside-item banner">
                    <div class="aside-content">
                        <a href="#">
                            <img src="{{url('/')}}/public/frontend/images/aside_banner.png" alt="banner" class="banner-img" />
                        </a>
                    </div>
                </aside>
            </aside>
